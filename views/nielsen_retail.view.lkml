view: nielsen_retail {
  ...
  dimension: display_order_1 {
    type: string
    sql: ${TABLE}.display_order_1 ;;
  }

  dimension: parent_tag_1 {
    type: string
    sql: ${TABLE}.parent_tag_1 ;;
  }

  dimension: hier_num_1 {
    type: string
    sql: ${TABLE}.hier_num_1 ;;
  }

  dimension: hier_name_1 {
    type: string
    sql: ${TABLE}.hier_name_1 ;;
  }

  dimension: hier_level_num_1 {
    type: string
    sql: ${TABLE}.hier_level_num_1 ;;
  }

  dimension: hier_level_name_1 {
    type: string
    sql: ${TABLE}.hier_level_name_1 ;;
  }
